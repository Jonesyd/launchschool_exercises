def longest_sentence(string)
  array = string.split(/\.|\?|\!/)
  array.map! { |sentence| sentence.split.count }
  puts "longest sentence has #{array.max} words"
end
